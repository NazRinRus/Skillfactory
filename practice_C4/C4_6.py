# разработка своей структуры данных
...
class LinkedList:  # класс списка
    ...
    def pushleft(self, value): #вставляет новый элемент в начало списка
    ...
    def popleft(self): #удаляет элемент с начала списка
    ...
    def popright(self): #удаляет элемент с конца списка
        if self.first is None:  # если список пустой, возвращаем None
            return None
        elif self.first == self.last:  # если список содержит только один элемент
            node = self.first  # сохраняем его
